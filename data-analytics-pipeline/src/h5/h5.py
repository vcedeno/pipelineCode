...
def cdPlot(action,bin,numlines,phases):
	...
	for i in range(numlines):
		...
		if not os.path.exists(os.getcwd()+'/data-analytics-pipeline/test/results/h5/output/'+action):
			os.makedirs(os.getcwd()+'/data-analytics-pipeline/test/results/h5/output/'+action)
	...
	plt.savefig(os.getcwd()+'/data-analytics-pipeline/test/results/h5/output/'+action+'/'+action+str(bin)+'Bin.png')
	plt.cla()
	plt.close(fig)
