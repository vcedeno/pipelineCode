...
def filescsv(n,d,numseconds,numlines,phases,csvfileall):
	allphases=[]
	nd="n"+str(n)+"d"+str(d)
	if not os.path.exists(os.getcwd()+'/data-analytics-pipeline/test/results/h7/output/'+nd):
		os.makedirs(os.getcwd()+'/data-analytics-pipeline/test/results/h7/output/'+nd)

	csvfile = open(os.getcwd()+'/data-analytics-pipeline/test/results/h7/output/'+nd+'/tsData.csv', 'w')
...
def main(filename,schemaname):
    ...
    #print(numlines)
    if not os.path.exists(os.getcwd()+'/data-analytics-pipeline/test/results/h7/output/all'):
    	os.makedirs(os.getcwd()+'/data-analytics-pipeline/test/results/h7/output/all')
    csvfileall = open(os.getcwd()+'/data-analytics-pipeline/test/results/h7/output/all/tsData.csv', 'w')
