...
def main(experimentfile,phasedescfile,phasefile,actionfile,playerfile,featureid,windowsize,nd,numseconds):
    ...
    featurejson=open(os.getcwd()+'/data-analytics-pipeline/json-schema/h10/input/datasets/h10.json', 'w')
    featurejson2=open(os.getcwd()+'/property-inference-pipeline/json-schema/inputTransformation/datasets/h10.json', 'w')
