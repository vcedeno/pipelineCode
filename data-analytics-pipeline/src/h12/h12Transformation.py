...
def main(experimentfile,phasedescfile,phasefile,actionfile,playerfile,featureid,windowsize,nd,numseconds):
    ...
    featurejson=open(os.getcwd()+'/data-analytics-pipeline/json-schema/h12/input/datasets/h12.json', 'w')
    featurejson2=open(os.getcwd()+'/property-inference-pipeline/json-schema/inputTransformation/datasets/h12.json', 'w')
