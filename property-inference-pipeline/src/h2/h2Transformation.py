...
def filescsv(n,d,numseconds,numlines,phases,csvfileall):
	allphases=[]
	nd="n"+str(n)+"d"+str(d)
	if not os.path.exists(os.getcwd()+'/property-inference-pipeline/json-schema/h2/input/datasets/'+nd):
		os.makedirs(os.getcwd()+'/property-inference-pipeline/json-schema/h2/input/datasets/'+nd)
	csvfile = open(os.getcwd()+'/property-inference-pipeline/json-schema/h2/input/datasets/'+nd+'/tsData.csv', 'w')
...
def main(filename,schemaname,groupslist):
    ...
    #print(numlines)
    if not os.path.exists(os.getcwd()+'/property-inference-pipeline/json-schema/h2/input/datasets/all'):
    	os.makedirs(os.getcwd()+'/property-inference-pipeline/json-schema/h2/input/datasets/all')
    csvfileall = open(os.getcwd()+'/property-inference-pipeline/json-schema/h2/input/datasets/all/tsData.csv', 'w')
